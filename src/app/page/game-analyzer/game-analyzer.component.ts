...
@Component({
  selector: 'app-game-analyzer',
  templateUrl: './game-analyzer.component.html',
  styleUrls: ['./game-analyzer.component.scss']
})
export class GameAnalyzerComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.store.dispatch(new PostAction.FetchPage("analyze-game"));
