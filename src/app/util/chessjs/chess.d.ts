...
export declare type InternalMove = {
    color: Color;
    from: number;
    to: number;
    piece: PieceSymbol;
...
export declare class Chess {
    ...
    _controlledAndSupportedSquares({ legal, piece, square, color, attacking }?: {
        legal?: boolean;
        piece?: PieceSymbol;
        square?: Square;
        color?: Color;
    ...
    getSupportedSquares({ legal, piece, square, color }?: {
        legal?: boolean;
        piece?: PieceSymbol;
        square?: Square;
        color?: Color;
    }): InternalMove[] | Move[];
    getAttackedSquares({ legal, piece, square, color }?: {
        legal?: boolean;
        piece?: PieceSymbol;
        square?: Square;
        color?: Color;
